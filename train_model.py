...
MODEL_PATH = "linear_regression_model.pkl"   # app.py inasoma jina hili -> tutahifadhi "best" model hapa
...
# ------------------------------------------------------------------
# CHAGUA MODEL BORA ZAIDI (R2 Score ya juu zaidi)
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# REFIT MODEL BORA KWA DATA YOTE (best practice kabla ya kuhifadhi)
# ------------------------------------------------------------------
...
# ------------------------------------------------------------------
# SAVE BEST MODEL (jina linabaki sawa kama linalotumiwa na app.py)
# ------------------------------------------------------------------
joblib.dump(final_pipeline, MODEL_PATH)
print(f"✅ Model bora ({best_model_name}) imehifadhiwa: {MODEL_PATH}")

# ------------------------------------------------------------------
# SAVE METRICS JSON (kwa ukurasa wa Model Performance)
# ------------------------------------------------------------------
metrics_json = {
...
print("✅ Metrics (models zote 3) na feature importance zimehifadhiwa outputs/")